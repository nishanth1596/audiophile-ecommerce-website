    ...
    <>
      <header className="bg-Black text-White border-b-White/10 border-b-[1px] px-6 py-8 md:px-10 lg:pb-9">
        <div className="flex items-center justify-between lg:max-w-[69.34rem] xl:mx-auto">
          ...
          <button
            className="group relative cursor-pointer transition-colors duration-300 ease-in-out"
          ...
          >
            ...
            >
              <path
                ...
                fill="#FFF"
                fillRule="nonzero"
                className="group-hover:fill-PrimaryColor transition-colors duration-300 ease-in-out"
              />
            </svg>
            {cartNumItems > 0 && (
